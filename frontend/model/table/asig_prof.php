<?php
	class asig_prof{
		...
		public function getMaterias($cod){
			global $conf_poli;
			$query = $this->mysql->query("SELECT distinct id, ccar_prof,abr_car,gdo_prof,tur_prof,gpo_prof,casg_prof,nom_pes,cal_prof,cod_prof,capint_prof, cin, tclas_int FROM `asig_prof`
